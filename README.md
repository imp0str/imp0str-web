...
The professional Web-development side of the imp0str ecosystem. This dependency-light static site is designed for GitHub Pages and intentionally keeps ecosystem destinations centralized in `js/routes.js`.
